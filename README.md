...
-  ⚡ **Engineering Focus**: Building full-stack MERN apps, deterministic engines, and scalable REST APIs.
-  🛠️ **Tech Stack**: JavaScript, React, Node.js, Express, MongoDB, MySQL, Git, and Docker.
...
- **Certification: Modern Web & App Development - Saylani Mass IT Training (SMIT)** · Mar 2026 - Present — Participating in modern web and app development training.
