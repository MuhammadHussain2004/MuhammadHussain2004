...
<!-- AUTO-TAGLINE:START -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Software+Engineer+%26+Full-Stack+MERN+Specialist;BSCS+Graduate+with+3.7%2F4.0+CGPA+from+Sindh+Madressatul+Islam+University;IBM+Certified+Full-Stack+JavaScript+Developer;Experienced+in+Building+Scalable+Web+Apps%2C+REST+APIs%2C+and+Recommendation+Engines;Proficient+in+React%2C+Node.js%2C+Express%2C+MongoDB%2C+Java%2C+and+C%2FC%2B%2B)](https://git.io/typing-svg)
<!-- AUTO-TAGLINE:END -->
...
-  💼 Professional experience as a MERN Stack Development Intern at 10Pearls and Full Stack Trainee at NextSkill Institute
-  📜 IBM Full-Stack JavaScript Developer Professional Certificate holder
-  🚀 Built BuildVolt: a PC-Build Recommendation SaaS and several full-stack MERN applications
-  🛠️ Strong technical stack featuring React, Node.js, Express, MongoDB, MySQL, and TypeScript
-  ✉️ Reach out via email at muhammadhussaintech@gmail.com or connect on LinkedIn and GitHub
<!-- AUTO-ABOUT:END -->
