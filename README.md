...
<!-- AUTO-TAGLINE:START -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Software+Engineer+%26+BSCS+Graduate;Full-Stack+MERN+Developer;IBM+Certified+JS+Developer;Systems+%26+Database+Design+Focus)](https://git.io/typing-svg)
<!-- AUTO-TAGLINE:END -->
...
-  💻 Experienced in full-stack MERN development, building SaaS platforms, and recommendation engines.
-  🛠️ Skilled in React, Node.js, Express, MongoDB, MySQL, and PostgreSQL.
-  ☁️ Proficient with Git, GitHub, Docker, and cloud deployments on Vercel.
-  ✉️ Reachable at muhammadhussaintech@gmail.com based in Karachi, Pakistan.
<!-- AUTO-ABOUT:END -->
...
- **Experience: NextSkill Institute - Full Stack Development Trainee** · Jun 2026 - Sep 2026 — Completed NAVTTC-affiliated Full Stack Development training with IBM-aligned curriculum, building front-end applications and e-commerce sites.
- **Experience: [10Pearls - 10Shine Program - MERN Stack Development Intern](https://github.com/MuhammadHussain2004/resume/blob/master/certificates/10Pearls_10Shine_Internship_Certificate.pdf)** · Apr 2026 - May 2026 — Designed data model and REST API for a full-stack Notes app with JWT authentication, email verification, CRUD operations, and unit testing.
- **Experience: Self-Directed Learning & Development - Independent Study** · Sep 2022 - Present — Built and deployed 10+ full-stack MERN applications independently, applying data structures, OOP, and database design coursework.
- **Education: Sindh Madressatul Islam University - Bachelor of Science in Computer Science** · Sep 2022 - Jun 2026 — Graduated with a CGPA of 3.7/4.0. Relevant coursework includes Data Structures, Object-Oriented Programming, Database Systems, Software Engineering, and Operating Systems.
...
- **Certification: Modern Web & App Development - Saylani Mass IT Training (SMIT)** · Mar 2026 - Present — Undergoing modern web and app development training.
